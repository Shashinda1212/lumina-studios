  ...
  return (
    ...
    >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col justify-between p-2 sm:p-3.5 min-h-0 mt-1.5 sm:mt-3">
                      <div className="text-center font-sans flex flex-col gap-1">
                        ...
                        {item.description && (
                          <p className="text-[8px] sm:text-[10px] text-neutral-400 line-clamp-2 font-light leading-normal select-text mt-1.5 sm:mt-3">
                            {item.description}
                          </p>
                        )}
                        ...
                        {item.tags && item.tags.length > 0 && (
                          <div className="flex flex-wrap justify-center gap-1.5 mt-2 sm:mt-2.5 mb-1 pointer-events-none">
                            {item.tags.map((tag, i) => {
      ...
      {showControls && (
        <div
          className={cn(
            "absolute inset-x-4 top-1/2 z-10 mx-auto flex w-fit items-center justify-center gap-3 rounded-full border border-neutral-300/80 bg-neutral-200/70 px-2 text-neutral-700 shadow-sm backdrop-blur-sm dark:border-white/10 dark:bg-neutral-900/70 dark:text-neutral-100",
            controlsClassName
          )}
          style={{ marginTop: `calc(${(safeSlideWidth * 2) / 3}px + 2rem)` }}
        >
          <button
            type="button"
